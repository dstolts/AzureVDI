...
$DestStorageAccountName = "hackathontempstorage" # Destination Storage Account
...
$ParametersObject = @{
	vhdPrefix = "vdigen"
	destinationContainerName = "genimages"
	overwriteVhds = "true"
}

Invoke-AzureRmResourceAction -ResourceGroupName $RGName -ResourceType Microsoft.Compute/virtualMachines -ResourceName Hackathon1 -Action deallocate -ApiVersion 2016-03-30 -Force
Invoke-AzureRmResourceAction -ResourceGroupName hackathon-client1 -ResourceType Microsoft.Compute/virtualMachines -ResourceName Hackathon1 -Action generalize -ApiVersion 2016-03-30 -Force
Invoke-AzureRmResourceAction -ResourceGroupName $RGName -ResourceType Microsoft.Compute/virtualMachines -ResourceName Hackathon1 -Action capture -Parameters $ParametersObject -ApiVersion 2016-03-30 -Force
...
#$srcBlob = $captureDisk.Name[1]
$srcBlob = ([System.Uri]$osvhduri).segments[2]
